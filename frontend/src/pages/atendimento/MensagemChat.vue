      ...
      <div v-for="(mensagem, index) in mensagens" :key="`mensagem-${index}`">
        ...
        >
          ...
          <div style="min-width: 100px; max-width: 350px" :style="mensagem.isDeleted ? 'color: rgba(0, 0, 0, 0.36) !important;' : ''">
            ...
            <q-btn v-if="!mensagem.isDeleted && isShowOptions" dense flat ripple round icon="mdi-chevron-down">  
              <q-menu square auto-close anchor="bottom left" self="top left">
                <q-list style="min-width: 100px">
                  <q-item :disable="!['whatsapp', 'telegram'].includes(ticketFocado.channel)" clickable @click="citarMensagem(mensagem)"  v-if="ticketFocado.channel === 'whatsapp'">
            ...
            <template v-if="mensagem.mediaType === 'notes'">
              <div v-html="formatarNotas(mensagem.body)"></div>
            </template>
            <template v-if="mensagem.mediaType === 'templates'">
              <div v-html="formatarTemplates(mensagem.body)"></div>
            </template>
            <template v-if="!['audio', 'vcard', 'image', 'video', 'sticker', 'location', 'interactive', 'button', 'button_reply', 'sticker', 'notes'].includes(mensagem.mediaType) && mensagem.mediaUrl">
